...
// wrapAmSolve
Rcpp::List wrapAmSolve(const Eigen::Map<Eigen::MatrixXd> X, const Eigen::Map<Eigen::VectorXd> y, const Eigen::Map<Eigen::VectorXd>& initCf, const Rcpp::StringVector& constraints, const Rcpp::IntegerVector& lambdaTermFreq, const Rcpp::IntegerVector& lambdaTermDim, int startIndex, int maxIter, int maxIterOptim, double tol, bool shouldCollectProgress, double startLambda);
RcppExport SEXP _papss_wrapAmSolve(SEXP XSEXP, SEXP ySEXP, SEXP initCfSEXP, SEXP constraintsSEXP, SEXP lambdaTermFreqSEXP, SEXP lambdaTermDimSEXP, SEXP startIndexSEXP, SEXP maxIterSEXP, SEXP maxIterOptimSEXP, SEXP tolSEXP, SEXP shouldCollectProgressSEXP, SEXP startLambdaSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(wrapAmSolve(X, y, initCf, constraints, lambdaTermFreq, lambdaTermDim, startIndex, maxIter, maxIterOptim, tol, shouldCollectProgress, startLambda));
    return rcpp_result_gen;
END_RCPP
}

static const R_CallMethodDef CallEntries[] = {
    {"_papss_wrapAmSolve", (DL_FUNC) &_papss_wrapAmSolve, 12},
    {NULL, NULL, 0}
};
